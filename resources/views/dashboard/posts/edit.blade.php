        ...
        <form action="/dashboard/posts/{{ $post->slug }}" method="POST" enctype="multipart/form-data">
          @method('PUT')
            ...
            <div class="mb-3">
              ...
              @if($post->image)
                <img src="{{ asset('storage/'.$post->image) }}" class="img-preview fluid mb-3 col-md-5 d-block" style="max-height: 180px; object-fit: cover; object-position: top; overflow: hidden">
              @else
